    ...
    return (
        <section
            ...
            style={{
                ...
                backgroundImage: 'url("https://images.pexels.com/photos/3467632/pexels-photo-3467632.jpeg?auto=compress&cs=tinysrgb&w=1920")',
        ...
        >
            ...
            <div
                ...
                style={{
                    background: `linear-gradient(135deg, rgba(0, 34, 85, 0.95), rgba(0, 34, 85, 0.85))`,
                }}
            ></div>
            ...
            <div className="container mx-auto relative z-10 max-w-6xl">
                <div className="lg:w-2/3">
                    ...
                    >
                        Rejoignez notre communauté sportive de classe mondiale où les champions sont formés. Des installations de pointe, des entraîneurs experts et un environnement favorable vous attendent à SportCity.
                    </p>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 mt-16 animate-fade-in-more-delayed">
                        {[
                            ...
                            { number: '15+', label: 'Année d\'expérience' }
                        ].map((stat, index) => (
