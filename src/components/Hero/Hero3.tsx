...
const Hero: React.FC = () => {
    return (
        <section
            ...
            style={{
                backgroundImage: 'url("https://images.pexels.com/photos/260352/pexels-photo-260352.jpeg?auto=compress&cs=tinysrgb&w=1920")',
        ...
        >
            ...
            <div
                ...
                style={{
                    background: `linear-gradient(135deg, rgba(0, 34, 85, 0.55), rgba(31, 83, 255, 0.55))`,
                }}
            ></div>
